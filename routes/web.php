...
Route::group(['middleware' => ['auth']], function(){
  ...
  //  Route::get('/pedidos/catalogo/{categoria}', 'App\Http\Controllers\PedidosController@productosPorCategoria')->name('pedidos.categoria');
    ...
    Route::post('/pedidos/catalogo', 'App\Http\Controllers\PedidosController@confirmarpedido')->name('pedidos.confirmar'); //REVISAR SI CORRESPONDE
